...
def build_hf_training_args(output_dir: str, lr: float,
                           batch_size: int, epochs: int,
                           weight_decay: float, warmup_ratio: float,
                           seed: int, fp16: bool,
...
def train_hf(
    ...
    targs = build_hf_training_args(
        output_dir, lr, batch_size, epochs, weight_decay, warmup_ratio, seed, fp16, grad_accum_steps
    )
